...
$sql = "select * from stw_pro order by id asc limit {$offset},{$pageSize}";
$rows = fetchAll($sql);
if(!$rows){
	...
	<div class="details">
		...
		<table class="table" cellspacing="0" cellpadding="0">
			...
			<tbody>
					...
					<td><input type="button" value="添加文字水印"
						onclick="doImg('<?php echo $row['id'];?>','waterText')"
						class="btn" /> <br /> <input type="button" value="添加图片水印"
