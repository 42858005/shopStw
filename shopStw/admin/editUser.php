...
<body>
<h3>编辑用户</h3>
<form id = "form1" action="doAdminAction.php?act=editUser&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		<td align="right">用户名</td>
		<td><input type="text" id="username" name="username" placeholder="<?php echo $row['username'];?>"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2"><input type = "button" value = "编辑用户" onclick = "checkNull()"/></td>
	</tr>
