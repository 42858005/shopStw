...
$sql = "select * from stw_user order by id asc limit {$offset},{$pageSize}";
$rows = fetchAll($sql);
if (! $rows) {
		...
		<table class="table" cellspacing="0" cellpadding="0">
			...
			<tbody>
					...
					<td align="center"><input type="button" value="修改" class="btn"
						onclick="editUser(<?php echo $row['id'];?>)"><input type="button"
						value="删除" class="btn" onclick="delUser(<?php echo $row['id'];?>)"></td>
				</tr>
                            <?php endforeach;?>
                <tr>
